// test/cleanup-and-test-voting.js
const axios = require('axios');
const config = require('./config');

class VotingLogicCleanupTester {
    constructor() {
    ...
    async runTests() {
        console.log('🚀 Testing Corrected Voting Logic (Clean Test)');
        console.log('=============================================');
        console.log('📋 Rules:');
        ...
        const existingComments = await this.getCommentsByProposal();
...
const tester = new VotingLogicCleanupTester();
tester.runTests();
